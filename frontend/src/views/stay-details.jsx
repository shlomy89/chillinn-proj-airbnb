    ...
    return (
        <div className="stay-details narrow main-layout">
            ...
            <div className="stay-details-content-container">
                <div className="stay-details-content">
                        ...
                        <div className="apartment-secondary-info">
                            <div className="apartment-secondary-header-container">
                                <span className="secondary-header">
                                    Entire serviced apartment hosted by Veller Homes
                                    <div className="apartment-content-container">
                                        <span>{stay.capacity} guests</span>·<span>{stay.bedrooms} bedrooms</span>·
                                        <span>2 beds</span>·<span>{stay.bathrooms} bathrooms</span>
                                    </div>
                                </span>
                                <img className="apartment-owner-img" src={stay.host.thumbnailUrl} />
                            </div>
                            <div className="apartment-content-container"></div>
                        </div>
                        <div className="border-bottom"></div>
                        <div className="apartment-info">{amenities.slice(0, 3)}</div>
                    </section>
                    <div className="border-bottom"></div>
                    ...
                    <section className="amenities-container">
                        ...
                        <div className="amenities-list-container">
                            <div className="amenities-list">{amenities.slice(0, 10)}</div>
                        </div>
                        <Collapse className="amenities-list" isOpened={isOpen}>
                            <div className="amenities-list-container">
                                <div className="amenities-list">{amenities.slice(10)}</div>
                            </div>
                        </Collapse>
                        {amenities.length > 10 && (
                            <button onClick={() => setIsOpen(!isOpen)} className="show-all-amenities">
                ...
                <ReservationCard stay={stay} reviews={reviews} rating={rating} />
            </div>
            ...
            <section className="things-to-know-container">
                <ThingToKnow header="House rules">
                    ...
                    <IconText text={'Pets are allowed'} Icon={PetsAllowedIcon} />
                </ThingToKnow>

                <ThingToKnow header="Health & safety">
                    <IconText text={"Airbnb's COVID-19 safety practices apply"} Icon={HealthCheckIcon} />
                    <IconText text={'Carbon monoxide alarm'} Icon={HealthCheckIcon} />
                    <IconText text={'Smoke alarm'} Icon={SmokingAlarmIcon} />
                </ThingToKnow>
                <ThingToKnow header="Cancellation policy">
                    This reservation is non-refundable.Review the Host's full cancellation policy which applies even if
